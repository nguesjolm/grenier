               ...
               <div class="row">
                   <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-12">
                       ...
                       <div class="card mb-4">
                           ...
                           <div class="card-body">
                               <!-- Form -->
                               <form action="upAd" get="GET">
                                   <div class="form-group mb-4">
                                       <label for="siteName" class="form-label">E-mail</label>
                                       <input class="form-control" id="siteName" placeholder=""
                                             type="text" value="{{$mail}}" name="usern"/>
                                   </div>
                                   <div class="form-group mb-4">
                                       <label for="siteName" class="form-label">Mot de Passe</label>
                                       <input class="form-control" id="siteName"
                                              name="pass" type="text" value="{{$pass}}" />
                                   </div>
