                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                            <div class="mb-2 mb-lg-0">
                                <h1 class="mb-1 h2 font-weight-bold">Nouvelles commandes({{$nb}})</h1>
                                <!-- Breadcrumb -->
                            ...
                            <div class="card-header border-bottom-0 p-0 bg-white">
                                <div>
                                    ...
                                    <ul class="nav nav-lb-tab" id="tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="courses-tab" data-toggle="pill" href="#courses" role="tab" aria-controls="courses" aria-selected="true">Nouvelle</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <tbody class="">
                                                  @foreach ($comd as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td class="align-middle border-top-0">
                                                            <a href="#!" class="btn btn-outline-success btn-sm livrer" id="{{$value->cmdCode}}">
                                                              Livrer
                                                            </a>
                                                        </td>
